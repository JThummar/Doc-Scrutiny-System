...
<html> 
    ...
    <body>
        ...
        <h1 style="color: blue; text-align:center; margin-top: 30px; font-style: italic">Sign Up For Officer</h1>
        ...
        <div class="row">
            ...
            <button type="submit" name="sign_up" class="btn btn-primary" style="background-color: blue">Create Account</button>
        </form>
        <hr class="rounded">
        <div class="form-group" style="width: 500px; margin: auto;">
        <a href="login.php">Already Have Account? Sign In Click Here</a>
        </div>
    </body>
</html>